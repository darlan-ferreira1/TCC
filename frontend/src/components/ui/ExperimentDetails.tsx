          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div className="flex flex-wrap gap-6 pb-8 border-b border-border">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-lg" style={{ fontFamily: "'DM Mono', monospace" }}>{experiment.rating.toFixed(1)}</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold" style={{ fontFamily: "'DM Mono', monospace" }}>{experiment.students.toLocaleString()}</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold" style={{ fontFamily: "'DM Mono', monospace" }}>{experiment.duration}</span>
            ...
            <div className="sticky top-8 bg-card border border-border rounded-xl p-6 shadow-sm">
              ...
              <div className="mt-6 space-y-3 pt-6 border-t border-border">
                {[
                  ...
                  { label: "Level", value: experiment.level },
                  { label: "Lessons", value: `${experiment.lessons.length} lessons` },
                  { label: "Students", value: experiment.students.toLocaleString() },
